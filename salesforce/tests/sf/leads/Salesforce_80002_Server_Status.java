...
public class Salesforce_80002_Server_Status extends UIDriver {

	public Salesforce_80002_Server_Status(ExtentTest test) {
		super(test);
	}

	//public static boolean sendPingRequest(Object[] array) throws UnknownHostException, IOException {
		public static boolean sendPingRequest(String TestCaseID,String ipAddress1,String ipAddress2,String randomNumber,String ApplicationName,String HeadLess) throws UnknownHostException, IOException {
